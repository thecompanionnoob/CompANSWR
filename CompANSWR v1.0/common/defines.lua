...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.18, -- Basic efficiency for taxes without 'crats and tech
	...
	BASE_MONTHLY_DIPLOPOINTS = 15, -- Base value gain for diplomatic actions each month
	...
	COLONIZATION_CREATE_STATE_COST = 25,
	...
	COLONIZATION_INFLUENCE_TEMPERATURE_PER_DAY = 0.0,
	COLONIZATION_INFLUENCE_TEMPERATURE_PER_LEVEL = 0.0,
...
diplomacy = {
	...
	INCREASERELATION_RELATION_ON_ACCEPT = 50,
	INCREASERELATION_RELATION_ON_DECLINE = 0,
	INCREASERELATION_DIPLOMATIC_COST = 2,

	DECREASERELATION_RELATION_ON_ACCEPT = -75,
	...
	TENSION_ON_CB_DISCOVERED = 0.0,
	TENSION_ON_REVOLT = 0.0,
